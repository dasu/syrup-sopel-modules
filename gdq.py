...
def gdq(bot, trigger):
    ...
    if now < gdqstart:
        ...
        if tts.days <= 3:
            ...
            return bot.say("Current Game: {0} by {1} ETA: {2} Comment: {3} | Next Game: {4} by {5} | http://www.twitch.tv/gamesdonequick | https://gamesdonequick.com/schedule".format(game, runner, eta, comment, nextgame, nextrunner))
        else:
